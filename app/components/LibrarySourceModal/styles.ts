...
export const connectPromptIcon = cva("flex size-16 items-center justify-center rounded-full");
...
export const brandIcon = cva("flex size-5 items-center justify-center rounded");
