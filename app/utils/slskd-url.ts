export interface SlskdUrlValidation {
  ok: boolean;
  normalized: string;
  error?: string;
  warning?: string;
...
const PATH_WARNING = "This looks like a page URL. The slskd API URL is usually the base, like http://host:port.";

export function validateSlskdApiUrl(rawValue: string): SlskdUrlValidation {
