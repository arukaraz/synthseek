...
export const selectionBar = cva(
  "border-fg/10 bg-surface/80 flex flex-wrap items-center gap-2 rounded-xl border px-3 py-2 sm:backdrop-blur-sm"
);

export const selectionChip = cva(
  "border-primary-500/30 bg-primary-500/15 text-fg inline-flex items-center gap-1.5 rounded-full border px-2.5 py-1 text-xs font-medium"
);
...
export const selectionAction = cva(
  "border-fg/10 bg-fg/[0.03] text-fg/70 hover:bg-fg/[0.06] hover:text-fg inline-flex items-center gap-1.5 rounded-md border px-2.5 py-1 text-xs font-medium transition-colors disabled:cursor-not-allowed disabled:opacity-50"
);

export const selectionClear = cva(
  "text-fg/60 hover:bg-fg/5 hover:text-fg ml-auto inline-flex items-center gap-1.5 rounded px-2 py-1 text-xs transition-colors"
);
