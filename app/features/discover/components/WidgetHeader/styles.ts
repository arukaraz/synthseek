...
export const widgetHeaderActionLink = cva(
  "text-primary-400 hover:text-primary-300 inline-flex shrink-0 items-center gap-1 self-center text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary-400 focus-visible:ring-offset-2 focus-visible:ring-offset-transparent rounded"
);
