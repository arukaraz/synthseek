...
| Variable      | What it is                                                                                                      |
| ------------- | --------------------------------------------------------------------------------------------------------------- |
| `AUTH_SECRET` | Signs sessions, and encrypts the credentials music apps use. At least 32 characters. Generate with `openssl rand -base64 48`. Changing it logs everyone out, and any music-app credential stops working in apps that use the older login scheme. Create a new credential after changing it. |
