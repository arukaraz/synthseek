...
| `/music`       | Your organised music library. Beets writes here.                                                                            | Can be mounted read-only, in which case Synthseek boots and browsing works, but imports and any reorganising of the library fail until it is writable. |
