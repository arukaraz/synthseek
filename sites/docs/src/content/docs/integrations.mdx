...
Beets no longer tags or files anything. It is still bundled, and Synthseek runs it only to check it is present, which is what the Beets CLI row in Settings reports.
